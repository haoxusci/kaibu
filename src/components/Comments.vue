<template>
  <div class="comments">
    ...
    <div class="reply">
      ...
      />
      <button class="reply--button" @click.prevent="addComment"><i class="fa fa-paper-plane"></i> Send</button>
    </div>
  </div>
</template>
  ...
  methods: {
    addComment(){
      ...
      const newComment = {
        firstComment: true,
        deleteStatus: false,
        createdTime: this.date.toUTCString(),
        updatedTime: this.date.toUTCString(),
        id: this.date.getTime(),
        user: this.current_user,
        content: this.comment,
        replyCommentIDs: []
      }
      if(this.current_user && this.comment){
